...
// EFT定制：启用通过 GPS 串口解析 VENDOR-MAG 帧注入罗盘数据的功能
#ifndef AP_COMPASS_UBLOX_GPS_ENABLED
#define AP_COMPASS_UBLOX_GPS_ENABLED 0
#endif
#ifndef AP_COMPASS_UBLOX_GPS_INSTANCE
#define AP_COMPASS_UBLOX_GPS_INSTANCE 0
#endif
