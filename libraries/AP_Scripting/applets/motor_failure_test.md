...
Motor failure is triggered by a RC switch configured to option 301 (Scripting2). Switch low all motors will run, switch high will stop motors.

If no RC channel is configured with option 301, the script exits silently without error.
